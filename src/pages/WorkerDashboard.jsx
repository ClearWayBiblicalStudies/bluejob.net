  ...
  return (
    <AppShell role="worker">
      ...
      <section className="dashboard-grid dashboard-grid-score">
        ...
        <article className="card metric-card"><span className="kicker">WORK PASSPORT</span><strong>92%</strong><span>Complete</span><div className="progress"><i style={{width:'92%'}}/></div><p>Finish verifying your profile.</p><Link to="/app/passport" className="metric-link">Open Passport</Link></article>
      ...
      <section className="card next-step"><div><span className="kicker">NEXT BEST STEP</span><h2>Verify your insurance</h2><p>Upload your current certificate of insurance to strengthen your Work Passport.</p></div><div className="next-icon"><ShieldCheck/></div><Link to="/app/verification" className="button button-primary">Take Action</Link></section>
