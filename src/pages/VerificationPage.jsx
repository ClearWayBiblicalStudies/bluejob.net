...
export default function VerificationPage() {
  ...
  const submit = (event) => { event.preventDefault(); if (!file) return; const next = [...evidence, { id: Date.now(), type, file, status: 'Pending Verification' }]; setEvidence(next); saveEvidence(next); setFile(''); event.target.reset(); };
