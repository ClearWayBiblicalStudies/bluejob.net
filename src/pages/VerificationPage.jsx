...
export default function VerificationPage() {
  ...
  return <AppShell role="worker"><div className="page-heading"><div><span className="kicker">PRIVATE DOCUMENTS</span><h1>Verification Center</h1><p>Submit proof privately. Verified results support your professional record.</p></div><Link to="/app/worker" className="back-link">View My Work Score →</Link></div>
