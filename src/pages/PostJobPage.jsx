...
export default function PostJobPage(){
  ...
  {step===0&&<div className="wizard-body"><span className="kicker">STEP 1</span><h2>Tell us about your project</h2><p>Provide details about the work you need completed.</p><label>Project Title<input defaultValue="Office Building Electrical"/></label><label>Project Description<textarea defaultValue="Electrical installation for a 3-story office building including power distribution, lighting and data cabling."/></label><label>Trade Category<select defaultValue="Electrical"><option value="Electrical">Electrical</option><option value="Framing">Framing</option><option value="Drywall">Drywall</option><option value="Concrete">Concrete</option></select></label><label>Project Location<input defaultValue="Tampa, FL"/></label></div>}
