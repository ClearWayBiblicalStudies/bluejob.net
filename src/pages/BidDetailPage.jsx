...
export default function BidDetailPage(){return <AppShell role="contractor"><div className="page-heading"><div><Link to="/app/contractor" className="back-link">← Back to Projects</Link><h1>Office Building Electrical</h1><p>Tampa, FL</p></div><span className="open-pill">● Bidding Open · closes in 2d 14h</span></div>
