...
app.get('/api/readyz', async (_, res) => {
...
validateEnvironment();
if (process.env.NODE_ENV !== 'test') app.listen(process.env.PORT || 3001, () => console.log(`BlueJob API listening on ${process.env.PORT || 3001}`));
